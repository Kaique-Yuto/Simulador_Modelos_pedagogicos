...
st.markdown("Use esta ferramenta para simular um portfólio de oferta em diversos polos da Ânima, com uma visão também para expansão de polos, tudo de acordo com as premissas do novo marco regulatório")
...
1. Ofertas de Curso --> Aqui é feita a inserção dos polos e seu portfólio de oferta, com a opção de buscar uma base de alunos existente na Ânima para iniciar a simulação.
...
- O simulador conta com base de alunos para 13 cursos na USJT, indicado por Cristiano Ferreira de Assis, que compõem cerca de 80% da oferta na USJT. São eles: 
...
- A base de alunos existente foi retirada de 2025/1, considerando apenas os ingressantes. Essa mesma base pode ser considerada como ingressantes em 2026/1 para fins de simulação.
...
- Essa sinergia é aplicada nas UCs iniciais de cada curso, até que a CH sinérgina se aproxime do percentual acima, conforme o modelo de oferta.
            
- O agrupamento de oferta é feito com base na Marca, Polo, Curso, Modelo de Oferta, Área do Conhecimento, UC, dessa maneira:
    ...
    - CHs Assíncronas, Síncronas Mediadas e Síncronas de UCs sinérgicas são agrupadas dentro da mesma Marca, Modelo de Oferta e Área do Conhecimento, independente do Polo.
        
    - CHs Assíncronas, Síncronas Mediadas e Síncronas de UCs específicas são agrupadas dentro da mesma Marca, Modelo de Oferta e Curso, independente do Polo.
...
- O ticket médio foi retirado por curso, modalidade, e marca, com base em 2025/1, de acordo com o BI de Performance Acadêmica 2025.
...
- O pagamento dos docentes inclui descansos remunerados, deixando um valor efetivo de 5,25 semanas por mês. Além disso, incluímos 170% sobre o valor para pagamento de encargos (Custo Semestral = Custo semanal * 5,25 * 1,7 * 6 * Qtde Turmas)
